...
export interface IObStoreOptions<S extends IObStoreSchema, V = S[keyof S]['value'], P = S[keyof S]['params']> {
    default?: V;
    params?: P;
    runOnInit?: boolean;
...
export declare type ObStoreSchema<S extends IObStoreSchema> = {
    [K in keyof S]: IObStoreOptions<S, S[K]['value'], S[K]['params']>;
};
export declare type ObStoreStore<S extends IObStoreSchema> = {
